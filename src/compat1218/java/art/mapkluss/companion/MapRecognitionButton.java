...
public final class MapRecognitionButton extends MapKlussButton {
    ...
    public MapRecognitionButton(int x, int y, int size, Runnable onPress) {
        ...
        setTooltip(Tooltip.of(Text.translatable("button.mapkluss-companion.recognize_maps")));
    }
    ...
    private static void drawMapGrid(DrawContext context, int x, int y, boolean hot) {
