...
public final class CompanionCollectionsScreen extends WorkshopTrackerScreen {
    ...
    private void rebuildCollectionButtons() {
        ...
        for(int i=start;i<end;i++) {
            ...
            collectionButton("collections.open",c.name()+"  ["+c.itemCount()+"]",WorkshopIcon.FOLDER,r,true,
                ()->client().setScreen(new CompanionCollectionItemsScreen(this,c,fixture)));
        }
        updatePageButton();
    }
    ...
    public void render(DrawContext context,int mouseX,int mouseY,float delta) {
        ...
        WorkshopDraw.text(context,textRenderer,CompanionI18n.translate("Коллекции"),s.heading().x()+4,s.heading().y()+6,s.heading().width()-48,workshopTheme.color("text-primary"));
