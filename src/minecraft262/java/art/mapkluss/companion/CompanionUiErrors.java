...
final class CompanionUiErrors {
    ...
    static String message(String operation, Throwable error) {
        ...
        return message(operation, error == null ? null : error.getMessage(), CompanionI18n.english(net.minecraft.client.Minecraft.getInstance()));
    }

    static String message(String operation, String detail) {
        return message(operation, detail, CompanionI18n.english(net.minecraft.client.Minecraft.getInstance()));
    }
